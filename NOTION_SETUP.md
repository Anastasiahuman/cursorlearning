...
|-------------|----------------|
| Имя         | Title (обычная первая колонка) |
| Email       | Email |
| Телефон     | Phone |
| Сумма       | Number |
| Оплата      | Text |
| Статус      | Select (варианты: **Не оплачено**, **Оплачено**) |
| Дата        | Date |

Если таблица уже есть по ссылке [ваша таблица](https://www.notion.so/30c59203544880e19b8af372b6c731d4?v=30c592035448800c9b08000cde8a4098) — добавьте в неё недостающие свойства с **точными именами** (Имя, Email, Телефон, Сумма, Оплата, Статус, Дата).
